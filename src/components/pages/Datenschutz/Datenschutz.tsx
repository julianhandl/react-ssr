...
class Datenschutz extends ContentPage {
    renderContent = () => {
        return <>
<h3>Datenschutz</h3>

Wir haben diese Datenschutzerklärung (Fassung 31.05.2019-221094977) verfasst, um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU) 2016/679 und dem Datenschutzgesetz (DSG) zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.
...
So können zum Beispiel Cookie-Daten aussehen:
    ...
    Beispielhafter Wert: GA1.2.1326744211.152221094977
...
<h5>Unbedingt notwendige Cookies</h5>
...
<h4>Allgemeine Informationen zu MailChimp</h4>
...
Jene Daten, die Google für einen Tag bzw. ein Jahr speichert können nicht einfach gelöscht werden. Die Daten werden beim Seitenaufruf automatisch an Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den Google-Support auf https://support.google.com/?hl=de&tid=221094977 kontaktieren. Datenspeicherung verhindern Sie in diesem Fall nur, wenn Sie unsere Seite nicht besuchen.

Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf https://developers.google.com/fonts/faq?tid=221094977. Dort geht zwar Google auf datenschutzrelevante Angelegenheiten ein, doch wirklich detaillierte Informationen über Datenspeicherung sind nicht enthalten. Es ist relativ schwierig (beinahe unmöglich), von Google wirklich präzise Informationen über gespeicherten Daten zu bekommen.
...
<ul>
    <li>
        ...
        <ul>
            ...
            <li>Beispielhafter Wert: GA1.2.1326744211.152221094977</li>
        </ul>
    </li>
    <li>
        _gid
        <ul>
            ...
            <li>Verwendung: Unterscheidung der Webseitenbesucher</li>
            <li>Beispielhafter Wert: GA1.2.1687193234.152221094977</li>
        </ul>
    </li>
    <li>
